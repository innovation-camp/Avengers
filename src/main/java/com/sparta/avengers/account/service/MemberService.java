...
import com.sparta.avengers.account.repository.MemberRepository;
...
public class MemberService {
    ...
    public ResponseDto<?> createMember(MemberRequestDto requestDto) {
        if (null != isPresentMember(requestDto.getName())) {
            return ResponseDto.fail("DUPLICATED_Name",
                    "중복된 닉네임 입니다.");
        }
    ...
    public ResponseDto<?> login(LoginRequestDto requestDto, HttpServletResponse response) {
        Member member = isPresentMember(requestDto.getName());
        if (null == member) {
    ...
    public Member isPresentMember(String name) {
